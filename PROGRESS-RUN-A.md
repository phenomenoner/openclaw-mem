...
| T09 | running | HEAD-on-commit | Slices 1-2 moved ingest/store plus harvest recovery, SQLite, index, embedding, and archive transitions into output-free core records functions; CLI commands are thin presentation shells. Harvest orphan-processing scenario and core/CLI focused gates pass. Episodes extraction remains before T09 completion. |
