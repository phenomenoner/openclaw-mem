...
| T09 | running | HEAD-on-commit | Slice 1 moved ingest receipt/state handling and store SQLite/vector/Markdown behavior into output-free core records functions; CLI commands are thin presentation shells. Focused core/CLI compatibility gate: 15 passed. Harvest and episodes extraction remain before T09 completion. |
