...
- Documented deterministic `triage --mode tasks` marker grammar updates (plain + bracketed markers, prefix normalization, accepted separators) in `README.md`, `QUICKSTART.md`, and `docs/upgrade-checklist.md`.
